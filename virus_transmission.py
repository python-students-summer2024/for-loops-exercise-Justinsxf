...
def calculate_infections(starting_number_infections, reproduction_rate, num_days):
    """
    Write a function that predicts the approximate number of infected individuals from a 
    socially-transmitted viral infection after a given number of days.
    ...
    number_of_infections = starting_number_infections
    for _ in range(num_days):
        number_of_infections *= reproduction_rate
    return round(number_of_infections)
